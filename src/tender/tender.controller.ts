...
export class TenderController {
    ...
    // ── Vendors ──────────────────────────────────────────────────────────
    @Get('vendors')
    listVendors(@Req() req: AuthenticatedRequest, @Query('active') active?: string) {
        return this.vendors.list(this.getPanchayatId(req), { active: active == null ? undefined : active === 'true' })
    }
    ...
    @Get('vendors/:id')
    getVendor(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
        return this.vendors.get(this.getPanchayatId(req), id)
    }

    @Patch('vendors/:id')
    updateVendor(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number, @Body() body: any) {
        return this.vendors.update(this.getPanchayatId(req), id, body)
    }

    @Delete('vendors/:id')
    deactivateVendor(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
        return this.vendors.deactivate(this.getPanchayatId(req), id)
    }

    // ── Tenders ──────────────────────────────────────────────────────────
    @Get('tenders')
    listTenders(@Req() req: AuthenticatedRequest, @Query('status') status?: string) {
        return this.tenders.list(this.getPanchayatId(req), { status })
    }

    @Post('tenders')
    createTender(@Req() req: AuthenticatedRequest, @Body() body: TenderCreateBody) {
        return this.tenders.create(this.getPanchayatId(req), req.user.id, body)
    }

    @Get('tenders/:id')
    getTender(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
    ...
    @Patch('tenders/:id')
    patchTender(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number, @Body() body: any) {
        return this.tenders.patch(this.getPanchayatId(req), id, req.user.id, body)
    }

    @Get('tenders/:id/timeline')
    timeline(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
    ...
    listAudit(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
    ...
    addLine(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number, @Body() body: TenderLineItemBody) {
        return this.tenders.addLineItem(this.getPanchayatId(req), id, req.user.id, body)
    }
    ...
    updateLine(
        ...
        return this.tenders.updateLineItem(this.getPanchayatId(req), id, itemId, req.user.id, body)
    }
    ...
    deleteLine(
        ...
        return this.tenders.deleteLineItem(this.getPanchayatId(req), id, itemId, req.user.id)
    }
    ...
    setInvites(
        ...
        return this.tenders.setInvites(this.getPanchayatId(req), id, req.user.id, body.vendor_ids)
    }

    // ── Lifecycle transitions ────────────────────────────────────────────
    @Post('tenders/:id/publish')
    publish(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
        return this.tenders.publish(this.getPanchayatId(req), id, req.user.id)
    }

    @Post('tenders/:id/close-quotations')
    closeQuotations(@Req() req: AuthenticatedRequest, @Param('id', ParseIntPipe) id: number) {
        return this.tenders.closeQuotations(this.getPanchayatId(req), id, req.user.id)
    }
    ...
    award(
        ...
        return this.tenders.award(this.getPanchayatId(req), id, req.user.id, body.quotation_id)
    }
    ...
    workCompletion(
        ...
        return this.tenders.recordWorkCompletion(this.getPanchayatId(req), id, req.user.id, body ?? {})
    }
    ...
    payment(
        ...
        return this.tenders.recordPayment(this.getPanchayatId(req), id, req.user.id, body)
    }
    ...
    addOfficerQuotation(
        @Req() req: AuthenticatedRequest,
        @Param('id', ParseIntPipe) id: number,
        @Body() body: { vendor_id?: number; submitter_name?: string; phone?: string; amount: number | string; remarks?: string; screening_outcome?: string }
    ) {
        return this.tenders.addOfficerQuotation(this.getPanchayatId(req), id, req.user.id, body)
    }
}
