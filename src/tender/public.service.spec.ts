...
describe('TenderPublicService', () => {
    const makeService = () => {
        const prisma: any = {
            ...
            tenderQuotation: { count: jest.fn(), findFirst: jest.fn(), create: jest.fn(), update: jest.fn() },
        ...
        const service = new TenderPublicService(prisma, storage, milestones, audit, vendors)
    ...
    it('marks invite as opened during invite read', async () => {
        ...
        prisma.tenderVendorInvite.findFirst.mockResolvedValue({
            ...
            vendor: { id: 3, name: 'Vendor One', phone_e164: '+919000000001', place: 'Town' },
            tender: {
                id: 7,
                title_ta: null,
