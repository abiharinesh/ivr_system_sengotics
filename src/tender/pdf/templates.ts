...
<style>
  ...
  .page { margin: 0 auto; position: relative; min-height: 960px; }
  ...
  .footer { display: flex; flex-wrap: wrap; gap: 24px; margin-top: 32px; }
  .footer > div { flex: 1 1 200px; }
  .sig { padding-top: 60px; border-top: 1px solid #444; }
  .small { font-size: 9pt; }
  ...
  .fabric-overlay svg { width: 100%; height: 100%; display: block; }
  ${layoutStyleBlock(ctx.layout ?? {})}
</style>
</head>
<body>
<div class="page">
