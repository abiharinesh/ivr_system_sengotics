...
export class DbSetupService {
    ...
    private async ensureTenderSchema(execSafe: (sql: string) => Promise<void>) {
        ...
        `)
        await execSafe(`CREATE UNIQUE INDEX IF NOT EXISTS vendors_panchayat_id_phone_e164_key ON vendors(panchayat_id, phone_e164);`)
        await execSafe(`CREATE INDEX IF NOT EXISTS vendors_panchayat_id_idx ON vendors(panchayat_id);`)
        ...
        `)
        await execSafe(`CREATE UNIQUE INDEX IF NOT EXISTS tenders_public_token_key ON tenders(public_token);`)
        await execSafe(`CREATE UNIQUE INDEX IF NOT EXISTS tenders_awarded_quotation_id_key ON tenders(awarded_quotation_id);`)
        await execSafe(`CREATE INDEX IF NOT EXISTS tenders_panchayat_id_status_idx ON tenders(panchayat_id, status);`)
        ...
        `)
        await execSafe(`CREATE INDEX IF NOT EXISTS tender_line_items_tender_id_idx ON tender_line_items(tender_id);`)
        ...
        `)
        await execSafe(`CREATE INDEX IF NOT EXISTS tender_quotations_tender_id_idx ON tender_quotations(tender_id);`)
        ...
        `)
        await execSafe(`CREATE INDEX IF NOT EXISTS tender_documents_tender_id_template_id_idx ON tender_documents(tender_id, template_id);`)
        ...
        `)
        await execSafe(`CREATE UNIQUE INDEX IF NOT EXISTS field_verification_sessions_token_key ON field_verification_sessions(token);`)
        await execSafe(`CREATE INDEX IF NOT EXISTS field_verification_sessions_tender_id_idx ON field_verification_sessions(tender_id);`)
        ...
        `)
        await execSafe(`CREATE INDEX IF NOT EXISTS tender_field_checklist_items_tender_id_idx ON tender_field_checklist_items(tender_id);`)
