...
class WaterRepository {
  ...
  List<Map<String, dynamic>> _mockTanks(int panchayatId) {
    return [
      {
        'id': 1,
        'name': 'Annur Main Elevated Reservoir (Mock)',
        'type': 'overhead_tank',
        'latitude': 11.2341,
        'longitude': 77.1025,
      ...
      {
        'id': 2,
        'name': 'Coimbatore Central Reservoirs (Mock)',
        'type': 'overhead_tank',
        'latitude': 11.0168,
        'longitude': 76.9616,
      ...
      {
        'id': 3,
        'name': 'Alngkhal Deep Borewell Pump (Mock)',
        'type': 'borewell_pump',
        'latitude': 11.0921,
        'longitude': 77.1232,
        'capacity_liters': 0.0,
