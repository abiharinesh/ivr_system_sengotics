...
import 'package:ivr_frontend/features/modules/reports/data/reports_repository.dart';
...
class _ReportGenerationScreenState extends State<ReportGenerationScreen> {
  ...
  String _generateHTMLData() {
    ...
    <body>
      <h1>$title</h1>
      <div class="subtitle">Ooraatchi Integrated GIS-Map & E-Tendering Console — Consolidated Audit Report</div>
      ...
      <div class="footer">
        <span>Generated by Ooraatchi Console on ${DateFormat('yyyy-MM-dd HH:mm').format(DateTime.now())}</span>
