...
import 'package:ivr_frontend/features/roles/plumber/data/plumber_self_repository.dart';

class PlumberComplaintDetailScreen extends StatefulWidget {
  const PlumberComplaintDetailScreen({super.key, required this.complaintId});

  final int complaintId;

  @override
  State<PlumberComplaintDetailScreen> createState() => _PlumberComplaintDetailScreenState();
}

class _PlumberComplaintDetailScreenState extends State<PlumberComplaintDetailScreen> {
