...
async function main() {
    ...
    console.log('✅ Created 2 panchayats')
    ...
    // Insert all poles with PostGIS geometry
    ...
    console.log(`✅ Created ${totalPoles} electric poles across 2 panchayats`)

    console.log('\n🎉 Database seeded successfully!')
    console.log(`\nSummary:`)
    console.log(`- Panchayats: 2 (Thayanur, Tholampalay)`)
    console.log(`- Electric Poles: ${totalPoles} (10 per panchayat)`)
    console.log(`- Landmarks per pole: 7 (Colloquial Tamil + Tanglish + English)`)
}
