...
Deployment notes:
- Vercel runs the versioned production seed during build. A fresh database
  receives the complete dataset once; after verification, later deployments
  skip the seed instead of rebuilding sample data.
